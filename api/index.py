            ...
            <div id="editorView" class="content-card view-hidden">
                <div class="editor-toolbar">
                    <div class="toolbar-left">
                        ...
                        <div class="toolbar-divider"></div>
                        <!-- AI Tools -->
                        <button class="toolbar-btn" id="toolbarCopy" title="Copy document to clipboard">
                        ...
                        <button class="toolbar-btn" id="toolbarPauseResume" title="Pause reading" hidden>
                            <svg class="icon-pause" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <line x1="9" y1="4" x2="9" y2="20"></line>
                                <line x1="15" y1="4" x2="15" y2="20"></line>
                            </svg>
                            <svg class="icon-resume" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <polygon points="6 3 20 12 6 21 6 3"></polygon>
                            </svg>
                            <span class="toolbar-label" id="pauseResumeLabel">Pause</span>
                        </button>
